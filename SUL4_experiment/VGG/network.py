...
class VGG19(M.Model):
	def initialize(self):
		...
		self.c51 = M.ConvLayer(3, 512, activation=M.PARAM_RELU, batch_norm=True, usebias=False, pad='SAME_LEFT')
		self.c52 = M.ConvLayer(3, 512, activation=M.PARAM_RELU, batch_norm=True, usebias=False, pad='SAME_LEFT')
		self.c53 = M.ConvLayer(3, 512, activation=M.PARAM_RELU, batch_norm=True, usebias=False, pad='SAME_LEFT')
		self.c54 = M.ConvLayer(3, 512, activation=M.PARAM_RELU, batch_norm=True, usebias=False, pad='SAME_LEFT')
		self.m5 = M.MaxPool(2, 2)

		self.fc1 = M.Dense(4096, activation=M.PARAM_RELU, batch_norm=True, usebias=False)
